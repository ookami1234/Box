...
CELERY_BEAT_SCHEDULE = {
    'update-channel-info-every-month': {
        'task': 'app.tasks.update_channel_info',
        'schedule': crontab(day_of_month='1', hour=0, minute=0),
    },
    'update-latest-videos-every-day': {
        'task': 'app.tasks.update_latest_videos',
        'schedule': crontab(hour=0, minute=0),
    },
}

HASHID_SALT = os.getenv('HASHID_SALT', 'your_default_salt_here')
